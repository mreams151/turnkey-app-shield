-- Corrected seed test data for TurnkeyAppShield admin panel
-- Uses the correct column names from the actual schema

-- Insert test rule templates (using correct column names)
INSERT INTO license_rules (name, description, max_concurrent_sessions, max_devices, max_days, allow_offline_days, allowed_countries, is_active) VALUES
('Standard License', 'Basic license for individual users with standard features', 2, 3, 365, 7, '["US", "CA", "GB", "AU"]', 1),
('Premium License', 'Enhanced license with premium features and extended support', 5, 10, 365, 30, '[]', 1),
('Enterprise License', 'Full-featured license for enterprise customers', 20, 50, 730, 90, '[]', 1),
('Trial License', 'Limited trial license for evaluation purposes', 1, 1, 30, 1, '["US", "CA", "GB"]', 1),
('Geographic Restricted', 'License restricted to specific geographic regions', 3, 5, 365, 14, '["US", "CA"]', 1);
